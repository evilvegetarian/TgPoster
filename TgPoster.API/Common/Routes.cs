...
internal static class Routes
{
	...
	{
		internal const string Root = Base + "/telegram-session";
		internal const string Create = Root;
		internal const string List = Root;
		internal const string Update = Root + "/{id:guid}";
		internal const string Delete = Root + "/{id:guid}";
	...
	internal static class Discover
	{
		...
		internal const string Stats = Root + "/stats";
		internal const string ParseHistory = Root + "/parse-history";
	...
	internal static class Repost
	{
		...
		internal const string AddDestinationsFromDiscoverFilter =
			Root + "/settings/{settingsId:guid}/destinations/from-discover-filter";
