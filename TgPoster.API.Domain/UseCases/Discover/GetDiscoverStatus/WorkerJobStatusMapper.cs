...
/// <summary>
///     Превращает сырое состояние фоновой задачи из хранилища в эффективный статус для фронта
/// </summary>
internal static class WorkerJobStatusMapper
{
	/// <summary>
	...
	/// <summary>
	///     Посчитать эффективный статус задачи на момент <paramref name="now" />
	/// </summary>
	/// <param name="state"></param>
	/// <param name="now"></param>
	/// <returns></returns>
	public static DiscoverStatusResponse ToResponse(WorkerJobStateDto? state, DateTimeOffset now)
	{
		if (state is null)
		{
