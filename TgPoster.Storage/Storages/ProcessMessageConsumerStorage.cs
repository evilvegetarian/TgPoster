	...
	: IProcessMessageConsumerStorage
{
	...
	public Task CreateMessagesAsync(List<MessageDto> messageDtos, CancellationToken ct)
	{
		var messages = messageDtos.Select(x =>
		{
		...
		context.Messages.AddRangeAsync(messages, ct);
