...
public sealed class Helper
{
    ...
    public Day BuildDay(Guid scheduleId, DayOfWeek? dayOfWeek = null, IEnumerable<TimeOnly>? timePostings = null, Action<Day>? configure = null)
    {
    ...
    public ChannelParsingSetting BuildChannelParsingSetting(Guid scheduleId, ParsingStatus status = ParsingStatus.New, bool checkNewPosts = false, Action<ChannelParsingSetting>? configure = null)
    {
    ...
    public MessageFile BuildMessageFile(Guid messageId, string contentType = "image/jpeg", Action<MessageFile>? configure = null)
    {
    ...
    public async Task<User> CreateUserAsync(Action<User>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<TelegramBot> CreateTelegramBotAsync(Guid? ownerId = null, Action<TelegramBot>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        User owner;
        if (ownerId.HasValue)
        {
            owner = await context.Users.FindAsync(new object?[] { ownerId.Value }, cancellationToken)
    ...
    public async Task<Schedule> CreateScheduleAsync(Guid? userId = null, Guid? telegramBotId = null, Action<Schedule>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        User user;
        if (userId.HasValue)
        {
    ...
    public async Task<Day> CreateDayAsync(Guid? scheduleId = null, DayOfWeek? dayOfWeek = null, IEnumerable<TimeOnly>? timePostings = null, Action<Day>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        Schedule schedule;
    ...
    public async Task<ChannelParsingSetting> CreateChannelParsingParametersAsync(Guid? scheduleId = null, ParsingStatus status = ParsingStatus.New, bool checkNewPosts = false, Action<ChannelParsingSetting>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        Schedule schedule;
        if (scheduleId.HasValue)
        {
    ...
    public async Task<Message> CreateMessageAsync(Guid? scheduleId = null, Action<Message>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        Schedule schedule;
        if (scheduleId.HasValue)
        {
    ...
    public async Task<IReadOnlyList<Message>> CreateMessagesAsync(Guid scheduleId, int count, Action<Message>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        if (count <= 0)
        {
    ...
    public async Task<MessageFile> CreateMessageFileAsync(Guid messageId, string contentType = "image/jpeg", Action<MessageFile>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<VideoMessageFile> CreateVideoMessageFileAsync(Guid messageId, Action<VideoMessageFile>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        var message = await context.Messages.FindAsync([messageId], cancellationToken)
                      ?? throw new InvalidOperationException($"Message {messageId} not found.");
    ...
    public async Task<RefreshSession> CreateRefreshSessionAsync(Guid? userId = null, Action<RefreshSession>? configure = null, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        User user;
        if (userId.HasValue)
        {
