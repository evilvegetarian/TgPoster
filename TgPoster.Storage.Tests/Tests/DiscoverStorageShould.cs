    ...
    : IClassFixture<StorageTestFixture>
{
    ...
    public async Task GetDiscoverChannelsAsync_WhenNoCategoryFilter_ShouldReturnOnlyCompletedChannels()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, null, null, null, null, null, DiscoverSortBy.Participants, SortDirection.Desc);
    ...
    public async Task GetDiscoverChannelsAsync_WhenCategoryFilter_ShouldReturnOnlyMatchingCategory()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, category, null, null, null, null, DiscoverSortBy.Participants, SortDirection.Desc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenSearchFilter_ShouldFilterByTitleOrUsername()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, null, $"crypto", null, null, null, DiscoverSortBy.Participants, SortDirection.Desc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenPeerTypeFilter_ShouldReturnOnlyMatchingType()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, null, marker, "channel", null, null, DiscoverSortBy.Participants, SortDirection.Desc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_ShouldSupportPagination()
    {
        ...
        var page1 = await sut.GetDiscoverChannelsAsync(new ListDiscoverQuery(1, 2, tag, null, null, null, null, DiscoverSortBy.Participants, SortDirection.Desc), CancellationToken.None);
        var page2 = await sut.GetDiscoverChannelsAsync(new ListDiscoverQuery(2, 2, tag, null, null, null, null, DiscoverSortBy.Participants, SortDirection.Desc), CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenMinParticipantsFilter_ShouldExcludeSmallerChannels()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, category, null, null, 1000, null, DiscoverSortBy.Participants, SortDirection.Desc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenMinAndMaxParticipantsFilter_ShouldReturnOnlyInRange()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, category, null, null, 1000, 10000, DiscoverSortBy.Participants, SortDirection.Desc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenSortByParticipantsAsc_ShouldOrderAscending()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, category, null, null, null, null, DiscoverSortBy.Participants, SortDirection.Asc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
    ...
    public async Task GetDiscoverChannelsAsync_WhenSortByTitleAsc_ShouldOrderAlphabetically()
    {
        ...
        var query = new ListDiscoverQuery(1, 50, category, null, null, null, null, DiscoverSortBy.Title, SortDirection.Asc);
        var result = await sut.GetDiscoverChannelsAsync(query, CancellationToken.None);
